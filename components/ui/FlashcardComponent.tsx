...
export default function FlashcardComponent({ flashcard, flashcards, currentIndex, setCurrentIndex }: { flashcard: Flashcard, flashcards: Flashcard[], currentIndex: number, setCurrentIndex: (index: number) => void }) {
  const [inputValue, setInputValue] = useState('');
  ...
  function nextCard() {
    ...
    if (currentIndex < flashcards.length - 1) {
      ...
      console.log("Reached the end of the flashcard deck.");
    }
  }
